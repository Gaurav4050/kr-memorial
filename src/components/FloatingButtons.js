...
export default function FloatingButtons() {
  return (
    <>
      <a
        href={hospitalInfo.social.whatsapp}
        target="_blank"
      ...
      <Link href="/appointment" className={styles.appointmentFab}>
        📅 Book Appointment
      </Link>
      <a href="tel:8006005111" className={styles.emergencyFab} aria-label="Emergency Call" title="Call: 8006005111 or 8006005105">
